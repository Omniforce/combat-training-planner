...
export default function Summary({ result }) {
  ...
  return (
    <div className="summary">
      ...
      <div className="summary-stat">
        <span className="summary-value summary-atk">{formatNumber(totalXp.attack)}</span>
        <span className="summary-label">Attack XP</span>
      </div>
      <div className="summary-stat">
        <span className="summary-value summary-str">{formatNumber(totalXp.strength)}</span>
        <span className="summary-label">Strength XP</span>
      </div>
      <div className="summary-stat">
        <span className="summary-value summary-def">{formatNumber(totalXp.defence)}</span>
